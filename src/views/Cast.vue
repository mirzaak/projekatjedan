...
<h1 @click="toMovie(this.movie.id)">{{this.movie.original_title}}</h1>
...
mounted(){
axios.get('https://api.themoviedb.org/3/movie/'+this.id+'/credits?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US')
.then((response)=>{
    this.podaci = response.data
    console.log(this.podaci)
})
axios.get('https://api.themoviedb.org/3/movie/'+this.id+'?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US')
.then((response)=>{
