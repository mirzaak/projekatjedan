...
<div class="okvir">
    ...
    <div class="glavno" v-if="watchlist">
        <div class="pojedinacno" v-for=" podatak in rated" :key="podatak"> 
...
export default {
    ...
    this.ratedtlength = response.data
    console.log(response)
      ...
      descending(){
        ...
        const deleteRating = await axios.delete('https://api.themoviedb.org/3/movie/' + id + '/rating?api_key=0b5e8ce7494ae54d6c643adf4db40da7&session_id=' + this.sesija)
        this.$router.go()
        },
        favorite(id){
